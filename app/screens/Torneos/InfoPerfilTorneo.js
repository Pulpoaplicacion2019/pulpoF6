    ...
    return (
        <View >
           ...
           <Avatar
              ...
              activeOpacity={0.7}
              containerStyle={{ marginLeft: 110, marginTop: 20, marginBottom:30}}
           />
        <TouchableOpacity hitSlop={{top: 50, bottom: 50, left: 50, right: 50}}  onPress={()=>this.props.navigation.navigate("PerfilTorneo")}
       ...
       <Icon name="edit" type="material-icons" style = {styles.button} />
          ...
          <Text style={styles.txt} > Nombre Torneo: {this.state.nombreTorneo+''}  </Text>
          <Text style={styles.txt}> Nombre Organizador: {this.state.nombreOrganizador+''} </Text>
          <Text style={styles.txt}> Apellido Organizador: {this.state.apellidoOrganizador+''} </Text>
          <Text style={styles.txt}> Teléfono Organizador: {this.state.telefonoOrganizador+''} </Text>
          <Text style={styles.txt}> Correo Organizador: {this.state.correoOrganizador+''} </Text>
          <Text style={styles.txt}> Fecha Inicio: {this.state.date+''}  </Text>
          <Text style={styles.txt}> Categorias: {this.state.listaCatTorneo+''}  </Text>
      </View>
    );
  }
}
